...
import { Network, Plus, Trash2, Shield, Activity, Search } from 'lucide-react';
import { useNetworks, useCreateNetwork, useDeleteNetwork } from '../api/client';
import { PageHeader } from '../components/Layout';
import { format } from 'date-fns';
import { clsx } from 'clsx';
import { CreateNetworkForm } from '../types';
...
export const Networks: React.FC = () => {
    ...
    const handleDelete = async (id: string, name: string) => {
        if (confirm(`Are you sure you want to delete network "${name}"? This action cannot be undone and will disconnect all nodes.`)) {
            try {
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span className="font-mono text-xs text-gray-900 dark:text-gray-200 truncate block" title={network.server_endpoint}>
            ...
            {isCreateModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Create New Network</h2>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Must be a /24 private subnet (e.g., 10.10.5.0/24). All networks are restricted to /24 for security and performance.
                                    </p>
                                </div>
                                ...
                                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg flex gap-3 text-sm text-blue-800 dark:text-blue-200">
                                    ...
                                    <p>
                                        A dedicated WireGuard interface and listening port will be automatically assigned to this network.
                                    </p>
                                </div>
